...
public extension UIImage {
    ...
    static func imageFromBase64String(_ base64String: String) -> UIImage? {
        ...
        return UIImage(data: imageData, scale: 2)
    }
}
